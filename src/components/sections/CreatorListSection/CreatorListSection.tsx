    ...
    <section className="flex flex-col items-start gap-[5px] p-[15px] lg:p-[20px] xl:p-[25px] bg-section-bg rounded-[12px] flex-1 overflow-hidden shadow-sm">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between w-full flex-shrink-0 mb-[10px] gap-3 sm:gap-4 xl:gap-6 min-w-0 overflow-hidden">
        ...
        <div className="flex items-center gap-[6px] lg:gap-[8px] xl:gap-[10px] min-w-0 overflow-hidden">
          <div className="inline-flex items-center h-[28px] lg:h-[32px] xl:h-[36px] rounded-[8px] border border-solid flex-shrink-0 min-w-0 overflow-hidden" style={{ borderColor: '#4b5563', backgroundColor: '#1f2937' }}>
            <button
            ...
            <div className="w-px h-[16px] sm:h-[20px] lg:h-[24px] xl:h-[28px] flex-shrink-0" style={{ backgroundColor: '#4b5563' }}></div>
