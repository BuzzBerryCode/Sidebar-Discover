      ...
      <div className="flex flex-col gap-[10px] lg:gap-[12px] xl:gap-[15px] w-full">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-[10px] lg:gap-[12px] xl:gap-[15px]">
            <h2 className="font-semibold text-[16px] lg:text-[18px] xl:text-[20px] leading-[20px] lg:leading-[24px] xl:leading-[28px] font-['Inter',Helvetica]" style={{ color: '#f9fafb' }}>
              Find Creators
            </h2>
            
            <Separator 
              orientation="vertical" 
              className="h-[20px] lg:h-[24px] xl:h-[28px]" 
              ...
              <div className="flex items-center flex-shrink-0">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div 
                      ref={dropdownRef}
                      className="absolute top-full right-0 mt-2 w-[280px] sm:w-[320px] lg:w-[360px] rounded-[12px] shadow-lg overflow-hidden max-h-[90vh] z-[9999]"
                      style={{
                        backgroundColor: '#1f2937',
                        borderColor: '#374151',
                        position: 'fixed',
                    ...
                    >
                      <div className="p-3 sm:p-4">
                        ...
                        <div className="mb-3 sm:mb-4">
                          <h3 className="text-[14px] sm:text-[16px] font-semibold" style={{ color: '#f9fafb' }}>
                            All Categories
                          </h3>
                        </div>
